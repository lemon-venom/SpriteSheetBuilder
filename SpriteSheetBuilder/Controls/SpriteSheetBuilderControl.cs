        ...
        private void btnMoveUp_Click(object sender, EventArgs e)
        {
            if (lstbxFiles.SelectedIndices.Count == 1)
            {
                ...
                if (selectedIndex > 0)
                {
                    ...
                    var imageSource = spriteSheetBuilderDto_.ImageSourceList[selectedIndex];

                    spriteSheetBuilderDto_.ImageSourceList.RemoveAt(selectedIndex);

                    spriteSheetBuilderDto_.ImageSourceList.Insert(newIndex, imageSource);
